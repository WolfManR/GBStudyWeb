...
namespace MetricsAgent.Controllers
{
    ...
    public class HddMetricsController : ControllerBase
    {
        ...
        public HddMetricsByTimePeriodResponse GetByTimePeriod([FromRoute] FreeHardDriveSpaceRequest request)
        {
            ...
            return new() { Metrics = result.Select(_mapper.Map<HddMetricResponse>) };
        }
    }
}