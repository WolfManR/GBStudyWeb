...
namespace MetricsAgent.DataBase.Repositories
{
    public class NetworkMetricsRepository : INetworkMetricsRepository
    {
        ...
        public NetworkMetricsRepository(SQLiteContainer container, ILogger<NetworkMetricsRepository> logger)
        {
        ...
        public void Create(NetworkMetric entity)
        {
            ...
            if (result > 0)
            {
                _logger.LogInformation(LogEvents.EntityCreationSuccess,"Network metric successfully added to database");
                return;
            }
