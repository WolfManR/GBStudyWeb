...
namespace MetricsAgent.Controllers
{
    ...
    public class NetworkMetricsController : ControllerBase
    {
        ...
        public NetworkMetricsByTimePeriodResponse GetByTimePeriod([FromRoute] NetworkMetricsRequest request)
        {
            ...
            return new() { Metrics = result.Select(_mapper.Map<NetworkMetricResponse>) };
        }
    }
}